        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="http://localhost:7882/demo/stars/template/pages/tables/tableU.php">User table</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
...
<select name="user_type">
      ...
      <input type="submit" value="register now" class="btn btn-primary me-2" name="submit">
