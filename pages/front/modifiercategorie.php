        ...
        <div class="main-panel">
         ...
         ?>
            <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Modifier USER</h4>
                    <form action="" method="POST" class="form-sample">

                      <p class="card-description"> Fiche Categorie : </p>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ID</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="id" id="id"  value = "<?php echo $categorie['id']; ?>" >
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" name="sexe" id="sexe" value="<?php echo $categorie['sexe']; ?>" maxlength="20">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="date" name="Date_N" id="Date_N" class="form-control"  value = "<?php echo $user['date_n']; ?>">
                            </div>
                          </div>
                        </div>
