...
if(isset($_POST['ajouter'])){
   ...
   $cart_id  = filter_var($cart_id, FILTER_SANITIZE_STRING);
      ...
      $insert_cart = $conn->prepare("INSERT INTO `commande`(user_id, pid, id_commande , quantite) VALUES(?,?,?,?)");
      $insert_cart->execute([$user_id, $pid, $cart_id ,$p_qty]);
      $message[] = 'added to commande!';
   }
...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex-btn">
         ...
         <input type="hidden" name="cart_id" value="<?= $fetch_cart['id']; ?>">
         <input type="submit" value="commander" name="ajouter" class="btn">
      </div>
