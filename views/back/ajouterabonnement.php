...
if (isset($_POST['Idt'])&& isset($_POST['search'])){
  ...
  <div class="container-scroller">
          ...
          <li class="nav-item dropdown d-none d-lg-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
              <a class="dropdown-item py-3" >
                <p class="mb-0 font-weight-medium float-left">Select abonnement</p>
              </a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="http://localhost:7070/demo/pages/forms/ajouterabonnement.php">Basic Elements</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="http://localhost:7070/demo/pages/tables/tableabonnement.php">User table</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Créer une abonnement</h4>
    ...
    <tr>
            ...
            <tr>
                ...
                <td><input type="datetime-local" name="DateDebut" id="DateDebut" maxlength="20"></td>
            </tr>
            </p>
